...
(function () {
  ...
  function renderSidebar() {
    ...
    return '' +
      ...
      '<img src="logo.png" alt="" class="w-12 h-12 rounded-lg object-cover shadow-sm flex-shrink-0" />' +
  ...
  function renderQuoteDocument(product, ctx, q) {
    ...
    return '<div style="width:794px;box-sizing:border-box;background:#ffffff;color:#0f172a;font-family:\'Sarabun\',\'Noto Sans Thai\',system-ui,-apple-system,sans-serif;padding:40px 44px;">' +
      ...
      '<div style="display:flex;align-items:center;gap:14px;"><img src="logo.png" alt="" crossorigin="anonymous" style="width:54px;height:54px;border-radius:10px;object-fit:cover;" />' +
